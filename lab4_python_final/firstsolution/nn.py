...
class NN(object):
	...
	def __init__(self,hidden_dims=(1024,2048),n_hidden=2,mode='train',dpath="C:\Users\Septio\OneDrive\nauka\rozpoznawanie obrazow\lab4_python_final\firstsolution\data",model_path=None):
